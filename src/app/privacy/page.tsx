    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 mx-auto max-w-3xl px-4 py-10 space-y-8">
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-between mb-4">
            <span className="text-xs text-muted-foreground">Last updated: February 26, 2026
            </span>
          </div>
           <br></br>
             <p className="text-muted-foreground">Astrotattwa ("we", "our", "us") values your privacy. This Privacy Policy explains how we collect, use, protect, and process your information when you access or use <a href="https://astrotattwa.com" class="text-primary hover:underline">https://astrotattwa.com</a>
             </p>
               
               <p className="text-sm text-muted-foreground mt-2"> By using our services, you agree to this policy.</p></div>
