    ...
    <div className={cn("space-y-6", className)}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div 
          className={cn(
            "lg:col-span-2",
            compareMode ? "flex gap-4" : ""
          )}
          {...swipeHandlers}
        >
          {compareMode ? (
            // Enhancement #3: Comparison Mode - Side by Side
              ...
              >
                ...
                <div className="space-y-3">
                  <div className="text-sm">
                    <div className="font-medium mb-1">{charts[compareIndices[0]].title}</div>
                    <div className="text-muted-foreground text-xs">
                      {charts[compareIndices[0]].subtitle}
                    </div>
                  </div>
                  
                  <div className="border-t pt-3 text-sm">
                    <div className="font-medium mb-1">{charts[compareIndices[1]].title}</div>
                    <div className="text-muted-foreground text-xs">
                      {charts[compareIndices[1]].subtitle}
                    </div>
                  </div>
                </div>
                
                <Button variant="outline" size="sm" className="w-full">
                  📊 Compare Planets Across Charts
                </Button>
              </motion.div>
            )}
          </AnimatePresence>
